...
$ALIYUNLOG log update_index --project_name=$PROJID --logstore_name=acslog-yundian-accesslog --index_detail=file://./accesslog_index.json
$ALIYUNLOG log update_index --project_name=$PROJID --logstore_name=acslog-yundian-phperr --index_detail=file://./phperr_index.json
$ALIYUNLOG log update_index --project_name=$PROJID --logstore_name=acslog-yundian-laravel --index_detail=file://./laravel_index.json